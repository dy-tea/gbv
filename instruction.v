...
const insts_unprefixed = [
	...
	CPUInstruction{'RLCA', 1, true, none}, // 0x07
	CPUInstruction{'LD a16, SP', 3, false, none}, // 0x08
	...
	CPUInstruction{'RRCA', 1, true, none}, // 0x0F
	CPUInstruction{'STOP', 2, true, none}, // 0x10
	...
	CPUInstruction{'RLA', 1, true, none}, // 0x17
	CPUInstruction{'JR e8', 2, true, none}, // 0x18
	...
	CPUInstruction{'ADD A, HL', 1, false, none}, // 0x86
	...
	CPUInstruction{'XOR A, HL', 1, false, none}, // 0xAE
	...
	CPUInstruction{'AND A, n8', 2, true, none}, // 0xE6
	CPUInstruction{'RST \$20', 1, true, inst_rst_20}, // 0xE7
	CPUInstruction{'ADD SP, e8', 2, true, none}, // 0xE8
	CPUInstruction{'JP HL', 1, true, none}, // 0xE9
	CPUInstruction{'LD a16, A', 3, false, none}, // 0xEA
	...
	CPUInstruction{'OR A, n8', 2, true, none}, // 0xF6
	CPUInstruction{'RST \$30', 1, true, inst_rst_30}, // 0xF7
	CPUInstruction{'LD HL, SP, e8', 2, true, none}, // 0xF8
	CPUInstruction{'LD SP, HL', 1, true, none}, // 0xF9
	CPUInstruction{'LD A, a16', 3, true, none}, // 0xFA
	CPUInstruction{'EI', 1, true, none}, // 0xFB
	CPUInstruction{'ILLEGAL_FC', 1, true, none}, // 0xFC
	CPUInstruction{'ILLEGAL_FD', 1, true, none}, // 0xFD
	CPUInstruction{'CP A, n8', 2, true, none}, // 0xFE
