...
const insts_unprefixed = [
	...
	CPUInstruction{'LD BC, A', 1, false, inst_ld_bc_a}, // 0x02
	CPUInstruction{'INC BC', 1, true, inst_inc_bc}, // 0x03
	CPUInstruction{'INC B', 1, true, inst_inc_b}, // 0x04
	CPUInstruction{'DEC B', 1, true, inst_dec_b}, // 0x05
	CPUInstruction{'LD B, n8', 2, true, inst_ld_b_n8}, // 0x06
	CPUInstruction{'RLCA', 1, true, inst_rlca}, // 0x07
	CPUInstruction{'LD a16, SP', 3, false, inst_ld_a16_sp}, // 0x08
	CPUInstruction{'ADD HL, BC', 1, true, inst_add_hl_bc}, // 0x09
	CPUInstruction{'LD A, BC', 1, false, inst_ld_a_bc}, // 0x0A
	CPUInstruction{'DEC BC', 1, true, inst_dec_bc}, // 0x0B
	CPUInstruction{'INC C', 1, true, inst_inc_c}, // 0x0C
	CPUInstruction{'DEC C', 1, true, inst_dec_c}, // 0x0D
	CPUInstruction{'LD C, n8', 2, true, inst_ld_c_n8}, // 0x0E
	CPUInstruction{'RRCA', 1, true, inst_rrca}, // 0x0F
	CPUInstruction{'STOP', 2, true, inst_stop}, // 0x10
	CPUInstruction{'LD DE, n16', 3, true, inst_ld_de_n16}, // 0x11
	CPUInstruction{'LD DE, A', 1, false, inst_ld_de_a}, // 0x12
	CPUInstruction{'INC DE', 1, true, inst_inc_de}, // 0x13
	CPUInstruction{'INC D', 1, true, inst_inc_d}, // 0x14
	CPUInstruction{'DEC D', 1, true, inst_dec_d}, // 0x15
	CPUInstruction{'LD D, n8', 2, true, inst_ld_d_n8}, // 0x16
	CPUInstruction{'RLA', 1, true, inst_rla}, // 0x17
	CPUInstruction{'JR e8', 2, true, inst_jr_e8}, // 0x18
	CPUInstruction{'ADD HL, DE', 1, true, inst_add_hl_de}, // 0x19
	CPUInstruction{'LD A, DE', 1, false, inst_ld_a_de}, // 0x1A
	CPUInstruction{'DEC DE', 1, true, inst_dec_de}, // 0x1B
	CPUInstruction{'INC E', 1, true, inst_inc_e}, // 0x1C
	CPUInstruction{'DEC E', 1, true, inst_dec_e}, // 0x1D
	CPUInstruction{'LD E, n8', 2, true, inst_ld_e_n8}, // 0x1E
	CPUInstruction{'RRA', 1, true, inst_rra}, // 0x1F
	CPUInstruction{'JR NZ, e8', 2, true, inst_jr_nz_e8}, // 0x20
	CPUInstruction{'LD HL, n16', 3, true, inst_ld_hl_n16}, // 0x21
	CPUInstruction{'LDI HL, A', 1, false, inst_ldi_hl_a}, // 0x22
	CPUInstruction{'INC HL', 1, true, inst_inc_hl}, // 0x23
	CPUInstruction{'INC H', 1, true, inst_inc_h}, // 0x24
	CPUInstruction{'DEC H', 1, true, inst_dec_h}, // 0x25
	CPUInstruction{'LD H, n8', 2, true, inst_ld_h_n8}, // 0x26
	CPUInstruction{'DAA', 1, true, inst_daa}, // 0x27
	CPUInstruction{'JR Z, e8', 2, true, inst_jr_z_e8}, // 0x28
	CPUInstruction{'ADD HL, HL', 1, true, inst_add_hl_hl}, // 0x29
	CPUInstruction{'LDI A, HL', 1, false, inst_ldi_a_hl}, // 0x2A
	CPUInstruction{'DEC HL', 1, true, inst_dec_hl}, // 0x2B
	CPUInstruction{'INC L', 1, true, inst_inc_l}, // 0x2C
	CPUInstruction{'DEC L', 1, true, inst_dec_l}, // 0x2D
	CPUInstruction{'LD L, n8', 2, true, inst_ld_l_n8}, // 0x2E
	CPUInstruction{'CPL', 1, true, inst_cpl}, // 0x2F
	...
	CPUInstruction{'INCI HL', 1, false, inst_inci_hl}, // 0x34
	CPUInstruction{'DECI HL', 1, false, inst_deci_hl}, // 0x35
	CPUInstruction{'LDI HL, n8', 2, false, inst_ldi_hl_n8}, // 0x36
	CPUInstruction{'SCF', 1, true, inst_scf}, // 0x37
	CPUInstruction{'JR C, e8', 2, true, inst_jr_c_e8}, // 0x38
	CPUInstruction{'ADD HL, SP', 1, true, inst_add_hl_sp}, // 0x39
	CPUInstruction{'LDD A, HL', 1, false, inst_ldd_a_hl}, // 0x3A
	...
	CPUInstruction{'CCF', 1, true, inst_ccf}, // 0x3F
	...
	CPUInstruction{'ADD A, E', 1, true, inst_add_a_e}, // 0x83
	CPUInstruction{'ADD A, H', 1, true, inst_add_a_h}, // 0x84
	CPUInstruction{'ADD A, L', 1, true, inst_add_a_l}, // 0x85
	CPUInstruction{'ADI A, HL', 1, false, inst_adi_a_hl}, // 0x86
	CPUInstruction{'ADD A, A', 1, true, inst_add_a_a}, // 0x87
	CPUInstruction{'ADC A, B', 1, true, inst_adc_a_b}, // 0x88
	CPUInstruction{'ADC A, C', 1, true, inst_adc_a_c}, // 0x89
	CPUInstruction{'ADC A, D', 1, true, inst_adc_a_d}, // 0x8A
	CPUInstruction{'ADC A, E', 1, true, inst_adc_a_e}, // 0x8B
	CPUInstruction{'ADC A, H', 1, true, inst_adc_a_h}, // 0x8C
	CPUInstruction{'ADC A, L', 1, true, inst_adc_a_l}, // 0x8D
	CPUInstruction{'ADC A, HL', 1, false, inst_adc_a_hl}, // 0x8E
	...
	CPUInstruction{'SUB A, E', 1, true, inst_sub_a_e}, // 0x93
	CPUInstruction{'SUB A, H', 1, true, inst_sub_a_h}, // 0x94
	CPUInstruction{'SUB A, L', 1, true, inst_sub_a_l}, // 0x95
	CPUInstruction{'SUB A, HL', 1, false, inst_sub_a_hl}, // 0x96
	...
	CPUInstruction{'SBC A, E', 1, true, inst_sbc_a_e}, // 0x9B
	CPUInstruction{'SBC A, H', 1, true, inst_sbc_a_h}, // 0x9C
	CPUInstruction{'SBC A, L', 1, true, inst_sbc_a_l}, // 0x9D
	CPUInstruction{'SBC A, HL', 1, false, inst_sbc_a_hl}, // 0x9E
	...
	CPUInstruction{'AND A, E', 1, true, inst_and_a_e}, // 0xA3
	CPUInstruction{'AND A, H', 1, true, inst_and_a_h}, // 0xA4
	CPUInstruction{'AND A, L', 1, true, inst_and_a_l}, // 0xA5
	CPUInstruction{'AND A, HL', 1, false, inst_and_a_hl}, // 0xA6
	...
	CPUInstruction{'XOR A, E', 1, true, inst_xor_a_e}, // 0xAB
	CPUInstruction{'XOR A, H', 1, true, inst_xor_a_h}, // 0xAC
	CPUInstruction{'XOR A, L', 1, true, inst_xor_a_l}, // 0xAD
	CPUInstruction{'XOR A, HL', 1, false, inst_xor_a_hl}, // 0xAE
	CPUInstruction{'XOR A, A', 1, true, inst_xor_a_a}, // 0xAF
	CPUInstruction{'OR A, B', 1, true, inst_or_a_b}, // 0xB0
	CPUInstruction{'OR A, C', 1, true, inst_or_a_c}, // 0xB1
	CPUInstruction{'OR A, D', 1, true, inst_or_a_d}, // 0xB2
	CPUInstruction{'OR A, E', 1, true, inst_or_a_e}, // 0xB3
	CPUInstruction{'OR A, H', 1, true, inst_or_a_h}, // 0xB4
	CPUInstruction{'OR A, L', 1, true, inst_or_a_l}, // 0xB5
	CPUInstruction{'OR A, HL', 1, false, inst_or_a_hl}, // 0xB6
	...
	CPUInstruction{'CP A, E', 1, true, inst_cp_a_e}, // 0xBB
	CPUInstruction{'CP A, H', 1, true, inst_cp_a_h}, // 0xBC
	CPUInstruction{'CP A, L', 1, true, inst_cp_a_l}, // 0xBD
	CPUInstruction{'CP A, HL', 1, false, inst_cp_a_hl}, // 0xBE
	...
	CPUInstruction{'ADD A, n8', 2, true, inst_add_a_n8}, // 0xC6
	CPUInstruction{'RST \$00', 1, true, inst_rst_00}, // 0xC7
	CPUInstruction{'RET Z', 1, true, inst_ret_z}, // 0xC8
	CPUInstruction{'RET', 1, true, inst_ret}, // 0xC9
	...
	CPUInstruction{'CALL a16', 3, true, inst_call_a16}, // 0xCD
	CPUInstruction{'ADC A, n8', 2, true, inst_adc_a_n8}, // 0xCE
	...
	CPUInstruction{'SUB A, n8', 2, true, inst_sub_a_n8}, // 0xD6
	CPUInstruction{'RST \$10', 1, true, inst_rst_10}, // 0xD7
	CPUInstruction{'RET C', 1, true, inst_ret_c}, // 0xD8
	CPUInstruction{'RETI', 1, true, inst_reti}, // 0xD9
	...
	CPUInstruction{'SBC A, n8', 2, true, inst_sbc_a_n8}, // 0xDE
	CPUInstruction{'RST \$18', 1, true, inst_rst_18}, // 0xDF
	CPUInstruction{'LDH a8, A', 2, false, inst_ldh_a8_a}, // 0xE0
	CPUInstruction{'POP HL', 1, true, inst_pop_hl}, // 0xE1
	CPUInstruction{'LDH C, A', 1, false, inst_ldh_c_a}, // 0xE2
	CPUInstruction{'ILLEGAL_E3', 1, true, none}, // 0xE3
	CPUInstruction{'ILLEGAL_E4', 1, true, none}, // 0xE4
	CPUInstruction{'PUSH HL', 1, true, inst_push_hl}, // 0xE5
	CPUInstruction{'AND A, n8', 2, true, inst_and_a_n8}, // 0xE6
	CPUInstruction{'RST \$20', 1, true, inst_rst_20}, // 0xE7
	CPUInstruction{'ADD SP, e8', 2, true, inst_add_sp_e8}, // 0xE8
	CPUInstruction{'JP HL', 1, true, inst_jp_hl}, // 0xE9
	CPUInstruction{'LD a16, A', 3, false, inst_ld_a16_a}, // 0xEA
	CPUInstruction{'ILLEGAL_EB', 1, true, none}, // 0xEB
	CPUInstruction{'ILLEGAL_EC', 1, true, none}, // 0xEC
	CPUInstruction{'ILLEGAL_ED', 1, true, none}, // 0xED
	CPUInstruction{'XOR A, n8', 2, true, inst_xor_a_n8}, // 0xEE
	CPUInstruction{'RST \$28', 1, true, inst_rst_28}, // 0xEF
	CPUInstruction{'LDH A, a8', 2, false, inst_ldh_a_a8}, // 0xF0
	CPUInstruction{'POP AF', 1, true, inst_pop_af}, // 0xF1
	CPUInstruction{'LDH A, C', 1, false, inst_ldh_a_c}, // 0xF2
	CPUInstruction{'DI', 1, false, inst_di}, // 0xF3
	CPUInstruction{'ILLEGAL_F4', 1, true, none}, // 0xF4
	CPUInstruction{'PUSH AF', 1, true, inst_push_af}, // 0xF5
	CPUInstruction{'OR A, n8', 2, true, inst_or_a_n8}, // 0xF6
	CPUInstruction{'RST \$30', 1, true, inst_rst_30}, // 0xF7
	CPUInstruction{'LD HL, SP, e8', 2, true, inst_ld_hl_sp_e8}, // 0xF8
	CPUInstruction{'LD SP, HL', 1, true, inst_ld_sp_hl}, // 0xF9
	CPUInstruction{'LD A, a16', 3, true, inst_ld_a_a16}, // 0xFA
	CPUInstruction{'EI', 1, true, inst_ei}, // 0xFB
	CPUInstruction{'ILLEGAL_FC', 1, true, none}, // 0xFC
	CPUInstruction{'ILLEGAL_FD', 1, true, none}, // 0xFD
	CPUInstruction{'CP A, n8', 2, true, inst_cp_a_n8}, // 0xFE
	CPUInstruction{'RST \$38', 1, true, inst_rst_38}, // 0xFF
]
